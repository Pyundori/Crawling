...
-- MariaDB dump 10.19  Distrib 10.6.7-MariaDB, for debian-linux-gnu (x86_64)
--
-- Host: localhost    Database: crawlind
-- ------------------------------------------------------
-- Server version	10.6.7-MariaDB-2ubuntu1.1
...
CREATE TABLE `crawledData` (
  ...
  `gImg` varchar(150) DEFAULT '',
  PRIMARY KEY (`pId`)
) ENGINE=InnoDB AUTO_INCREMENT=4054 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user` (
  ...
  PRIMARY KEY (`uid`) USING BTREE,
  UNIQUE KEY `UNIQUE_ID` (`id`,`type`) USING BTREE,
  UNIQUE KEY `UNIQUE_NAME` (`name`,`type`) USING BTREE,
  UNIQUE KEY `UNIQUE_EMAIL` (`email`,`type`) USING BTREE
...
-- Dump completed on 2022-09-02 14:27:48
